...
CREATE TABLE `t_user`  (
                           ...
                           `AUTH_KEY` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '验证器密钥',
                           `ACTIVATED_2FA` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否开启两步验证',
